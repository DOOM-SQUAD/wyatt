...
describe Wyatt::Configuration do
  ...
  describe '.load!' do
    ...
    it 'should initialize the value of file_path' do
      Wyatt::Configuration.stub(:parse_settings) { settings }
      Wyatt::Configuration.load!(file_path)

      Wyatt::Configuration.file_path.should eq(file_path)
    end

    it 'should call parse_settings' do
      Wyatt::Configuration.should_receive(:parse_settings).once.and_return(settings)
      Wyatt::Configuration.load!(file_path)
    end
  ...
  describe '.parse_settings' do
    ...
    it 'should call IO.read with the file path' do
      ...
      Wyatt::Configuration.parse_settings
    end
